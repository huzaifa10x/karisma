<script>
  import { Phone, Instagram, MessageCircle } from "lucide-svelte";
</script>

<div class="relative">
  <aside
    class="fixed right-0 lg:right-4 bottom-12 lg:-bottom-5 flex -translate-y-1/5 flex-col items-center z-40"
  >
    <div
      class="hidden mb-5 md:flex lg:flex gap-0 flex-col h-51 items-center border-2 border-[#808080] rounded shadow-gray-800 shadow-[4px_0_16px_-2px_rgba(0,0,0,0.1)] bg-[#405D53]"
    >
      <img
        src="/images/logo_main-3-DN-IBBiu.png"
        class="w-10.5 h-10.5 mt-4"
        alt=""
      />
    ...
    <div class="flex flex-col items-end">
      <a href="https://wa.me/971504525189?text=Help%20Me%21" class="mb-0.5">
        <!-- <Phone size={26} /> -->
        ...
        <svg
          ...
          ><g id="_08.whatsapp" data-name="08.whatsapp"
            ...
            ></circle><g id="icon" transform="translate(15 15)"
              ><path
                id="Path_10023"
      ...
      <a href="tel:+123456789" class="mb-0.5">
        <!-- <Phone size={26} /> -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="55"
          ...
          ><g id="chat" transform="translate(0.327 0.071)"
            ><g
              ...
              stroke="none"
              stroke-width="0"
              ><circle cx="34" cy="34" r="34" stroke="none"></circle><circle
                cx="34"
                cy="34"
                r="33.5"
                fill="none"
      ...
      <a href="https://www.instagram.com/karismamedicalcenter/"  class="mb-0.5">
        <!-- <Instagram size={26} /> -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          ...
          height="55"
          viewBox="0 0 68 78"
          ><g id="Layer_2" data-name="Layer 2" transform="translate(0.03 0.029)"
  ...
  <div
    class="lg:hidden md:hidden gap-5 z-30 py-1.5 flex fixed bottom-0 justify-center items-center border-2 border-[#808080] bg-[#405D53] w-full"
  >
    <img src="/images/logo_main-3-DN-IBBiu.png" class="w-12.5 h-12.5" alt="" />

    <span class="text-white font-bold uppercase text-[19px]">
      Appointment
    </span>
  </div>
</div>
